...
class _BaseMetric(ABC):
    ...
    def summary_results(self, table_res):
        ...
        print('summary key',table_res.keys())
        
        summary_results=dict()
        for seq, res in table_res.items():
            summary_row = self._summary_row(res)
            summary_results[seq]= dict(zip(self.summary_fields, summary_row))
