...
class JRDB3DTraj(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            ...
            #'TRAJ_FOLDER': os.path.join(code_path, 'data/trackers/jrdb/jrdb_3d_box_train/'),  # Trackers location
            # /pvol2/jrdb_dev/jrdb_website_dev/media/submissions/u6361796@anu.edu.au/3dt/2021-10-28 12:10:45+00:00_ab3dmot2/
            #'TRAJ_FOLDER': os.path.join(code_path, '/pvol2/jrdb_dev/jrdb_website_dev/media/submissions/u6361796@anu.edu.au/3dt/2021-10-28 12:10:45+00:00_ab3dmot2/'),
            'TRAJ_FOLDER': os.path.join(code_path, '/pvol2/jrdb_dev/jrdb_website_dev/media/submissions/u6361796@anu.edu.au/3dt/2021-10-28 12:16:27+00:00_jrdb-jrmot2/'),
            'OUTPUT_FOLDER': None,  # Where to save eval results (if None, same as TRAJ_FOLDER)
    ...
    def __init__(self, config=None):
        ...
        self.tracker_fol = self.config['TRAJ_FOLDER']
        ...
        self.seq_list = []
        self.seq_lengths = {}
        seqmap_name = 'evaluate_trajectory.seqmap.' + self.config['SPLIT_TO_EVAL']
            ...
            for row in reader:
                if len(row) >= 4:
                    ...
                    if not self.data_is_zipped:
                        curr_file = os.path.join(self.gt_fol, 'data', seq + '.txt')
                        #print(curr_file)
    ...
    def _load_raw_file(self, tracker, seq, is_gt):
        ...
        if self.data_is_zipped:
            ...
            zip_file = None
            if is_gt:
                file = os.path.join(self.gt_fol, 'data', seq + '.txt')
            else:
        ...
        num_timesteps = 12 #self.seq_lengths[seq]
        ...
        current_time_keys = [str(self.seq_lengths[seq]-(num_timesteps-t-1)*6-1) for t in range(num_timesteps)]
        ...
        for t in range(num_timesteps):
            time_key = current_time_keys[t]#str(t)
